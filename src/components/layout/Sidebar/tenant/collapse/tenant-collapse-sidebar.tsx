...
import { RenderCollapseMenus } from "./tenant-render-collapse-menus";
import { RenderCollapseSubmenus } from "./tenant-render-collapse-submenu";
import SidebarHeaderContent from "./tenant-sidebar-header";
import SidebarFooterContent from "./tenant-sidebar-footer";
import { useMounted } from "@/hooks/use-mounted";
import { GroupedMenus, MenuItem } from "@/lib/menus";


const TenantCollapseMenus = React.memo(({ menus = [] }: { menus: GroupedMenus[] }) => {
...
TenantCollapseMenus.displayName = 'TenantCollapseMenus';
export default TenantCollapseMenus;
